...
static void App_Init(void)
{
	...
	/* 画面 */
	g_nCrtmod = CRTC_INIT(11);	/* mode=11 256x256 col:256 15kHz */
#ifdef DEBUG	/* デバッグコーナー */
	puts("App_Init 画面");
#endif
