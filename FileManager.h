...
extern SS Load_Music_List(	SC *, SC *, SC (*)[256], UI *);
extern SS Load_SE_List(		SC *, SC *, SC (*)[256], UI *);
extern SS Load_CG_List(		SC *, SC *, CG_LIST *, UI *);
extern SS Load_MACS_List(	SC *, SC *, SC (*)[256], UI *);
